        ...
        <div className="container mx-auto px-0 sm:px-6 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center px-4 sm:px-0">
            ...
            <div className="flex flex-col space-y-8 md:space-y-10">
              ...
              <div className="border-2 border-pk-green-main/30 bg-gradient-to-br from-background to-background/80 p-6 md:p-8 transition-all duration-300 hover:shadow-lg hover:bg-black cursor-pointer group">
