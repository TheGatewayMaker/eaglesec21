  ...
  return (
    ...
    >
      ...
      <section className="bg-gradient-to-b from-background via-background to-background/95 text-foreground relative overflow-hidden py-10 sm:py-14 md:py-20 lg:py-32 transition-colors duration-300">
        ...
        <div className="absolute top-1/3 right-0 w-72 h-72 bg-pk-green-main/4 rounded-full blur-3xl translate-x-1/3"></div>
        <div className="absolute bottom-0 left-1/4 w-80 h-80 bg-accent/3 rounded-full blur-3xl translate-y-1/2"></div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-24 bg-gradient-to-b from-background via-background to-background/95 transition-colors duration-300 relative overflow-hidden">
        {/* Decorative Background Elements */}
        <div className="absolute top-1/4 right-0 w-96 h-96 bg-accent/4 rounded-full blur-3xl translate-x-1/3"></div>
        <div className="absolute bottom-1/4 left-0 w-80 h-80 bg-pk-green-main/3 rounded-full blur-3xl -translate-x-1/3"></div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-28 bg-gradient-to-b from-background/95 via-background to-background transition-colors duration-300 relative overflow-hidden">
        {/* Decorative Background Elements */}
        <div className="absolute top-1/2 right-0 w-96 h-96 bg-accent/4 rounded-full blur-3xl translate-x-1/3 -translate-y-1/2"></div>
        <div className="absolute bottom-1/4 left-0 w-80 h-80 bg-pk-green-main/3 rounded-full blur-3xl -translate-x-1/2"></div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-28 bg-gradient-to-b from-background to-background/95 transition-colors duration-300 relative overflow-hidden">
        {/* Decorative Background Elements */}
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-pk-green-main/4 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-1/3 right-0 w-80 h-80 bg-accent/3 rounded-full blur-3xl translate-x-1/2"></div>
      ...
      <section className="py-10 sm:py-14 md:py-20 lg:py-24 bg-gradient-to-b from-background via-background/95 to-background transition-colors duration-300 border-y border-pk-green-main/20 relative overflow-hidden">
        {/* Decorative Background Elements */}
        <div className="absolute top-1/4 left-0 w-80 h-80 bg-accent/3 rounded-full blur-3xl -translate-x-1/2"></div>
        <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-pk-green-main/4 rounded-full blur-3xl translate-x-1/3"></div>
